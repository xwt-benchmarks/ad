...
import com.kuyikeji.filemanager.utils.LruBitmapCache;
...
public class AppConfig extends GlideApplication {
    ...
    public void onCreate() {
        ...
        UMConfigure.init(this,"5b889f028f4a9d79370000bf","GooglePlay",UMConfigure.DEVICE_TYPE_PHONE,null);
        UMConfigure.setLogEnabled(true);
        MobclickAgent.setSessionContinueMillis(1000 * 40);
        MobclickAgent.setScenarioType(this, MobclickAgent.EScenarioType.E_UM_NORMAL);
      /*  DaemonEnv.initialize(this, ProtectAdvertisementService.class, DaemonEnv.DEFAULT_WAKE_UP_INTERVAL);
