...
package com.kuyikeji.filemanager.ui.views.drawer;
...
import com.kuyikeji.filemanager.BuildConfig;
import com.kuyikeji.filemanager.R;
import com.kuyikeji.filemanager.activities.MainActivity;
import com.kuyikeji.filemanager.activities.PreferencesActivity;
...
import com.kuyikeji.filemanager.fragments.preference_fragments.QuickAccessPref;
...
import com.kuyikeji.filemanager.utils.ScreenUtils;
import com.kuyikeji.filemanager.utils.TinyDB;
    ...
    public void refreshDrawer() {
        ...
        for (String file : storageDirectories) {
            ...
            if ("/storage/emulated/legacy".equals(file) || "/storage/emulated/0".equals(file) || "/mnt/sdcard".equals(file)) {
                ...
                icon1 = R.drawable.ic_sd_storage_gray_24dp;
            } else if ("/".equals(file)) {
