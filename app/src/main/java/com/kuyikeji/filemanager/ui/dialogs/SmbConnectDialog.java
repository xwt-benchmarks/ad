...
import com.kuyikeji.filemanager.utils.EditTextColorStateUtil;
import com.kuyikeji.filemanager.utils.SimpleTextWatcher;
import com.kuyikeji.filemanager.utils.SmbUtil;
...
public class SmbConnectDialog extends DialogFragment {
    ...
    public interface SmbConnectionListener {
         ...
         *             See {@link com.kuyikeji.filemanager.database.UtilsHandler#removeSmbPath(String, String)}
         */
