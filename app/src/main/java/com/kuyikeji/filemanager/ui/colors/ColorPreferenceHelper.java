package com.kuyikeji.filemanager.ui.colors;
...
public class ColorPreferenceHelper {
    ...
    public static final @ColorRes int DEFAULT_PRIMARY_FIRST_TAB = R.color.primary_deep_purple,
            DEFAULT_PRIMARY_SECOND_TAB = R.color.primary_deep_purple,
