package com.kuyikeji.filemanager.adapters;
...
import com.kuyikeji.filemanager.GlideApp;
import com.kuyikeji.filemanager.R;
import com.kuyikeji.filemanager.activities.superclasses.PreferenceActivity;
import com.kuyikeji.filemanager.adapters.data.IconDataParcelable;
import com.kuyikeji.filemanager.adapters.data.LayoutElementParcelable;
import com.kuyikeji.filemanager.adapters.glide.RecyclerPreloadModelProvider;
import com.kuyikeji.filemanager.adapters.glide.RecyclerPreloadSizeProvider;
import com.kuyikeji.filemanager.adapters.holders.EmptyViewHolder;
import com.kuyikeji.filemanager.adapters.holders.ItemViewHolder;
import com.kuyikeji.filemanager.adapters.holders.SpecialViewHolder;
import com.kuyikeji.filemanager.fragments.MainFragment;
import com.kuyikeji.filemanager.ui.ItemPopupMenu;
import com.kuyikeji.filemanager.ui.colors.ColorUtils;
import com.kuyikeji.filemanager.ui.icons.Icons;
import com.kuyikeji.filemanager.ui.icons.MimeTypes;
import com.kuyikeji.filemanager.ui.views.CircleGradientDrawable;
import com.kuyikeji.filemanager.ui.views.RoundedImageView;
import com.kuyikeji.filemanager.utils.AnimUtils;
import com.kuyikeji.filemanager.utils.GlideConstants;
...
import static com.kuyikeji.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_COLORIZE_ICONS;
import static com.kuyikeji.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_FILE_SIZE;
import static com.kuyikeji.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_GOBACK_BUTTON;
import static com.kuyikeji.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_HEADERS;
import static com.kuyikeji.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_LAST_MODIFIED;
import static com.kuyikeji.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_PERMISSIONS;
import static com.kuyikeji.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_THUMB;
import static com.kuyikeji.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_USE_CIRCULAR_IMAGES;
    ...
    private void showPopup(View v, final LayoutElementParcelable rowItem, final int position) {
        v.setOnClickListener(view -> {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
                ...
                else if(description.endsWith(CryptUtil.ENCRYPT_JPG) || description.endsWith(CryptUtil.ENCRYPT_PNG))
