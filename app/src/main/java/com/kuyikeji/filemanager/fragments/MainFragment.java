...
package com.kuyikeji.filemanager.fragments;
...
import com.kuyikeji.filemanager.activities.MainActivity;
import com.kuyikeji.filemanager.activities.superclasses.ThemedActivity;
import com.kuyikeji.filemanager.adapters.RecyclerAdapter;
import com.kuyikeji.filemanager.adapters.data.LayoutElementParcelable;
import com.kuyikeji.filemanager.asynchronous.asynctasks.DeleteTask;
import com.kuyikeji.filemanager.asynchronous.asynctasks.LoadFilesListTask;
import com.kuyikeji.filemanager.asynchronous.handlers.FileHandler;
import com.kuyikeji.filemanager.database.CloudHandler;
import com.kuyikeji.filemanager.database.CryptHandler;
import com.kuyikeji.filemanager.database.SortHandler;
import com.kuyikeji.filemanager.database.models.EncryptedEntry;
import com.kuyikeji.filemanager.database.models.Tab;
import com.kuyikeji.filemanager.filesystem.CustomFileObserver;
...
import com.kuyikeji.filemanager.filesystem.MediaStoreHack;
import com.kuyikeji.filemanager.filesystem.PasteHelper;
import com.kuyikeji.filemanager.filesystem.ssh.SshClientUtils;
import com.kuyikeji.filemanager.ui.dialogs.GeneralDialogCreation;
import com.kuyikeji.filemanager.ui.icons.MimeTypes;
import com.kuyikeji.filemanager.ui.views.DividerItemDecoration;
import com.kuyikeji.filemanager.ui.views.FastScroller;
import com.kuyikeji.filemanager.ui.views.RoundedImageView;
import com.kuyikeji.filemanager.ui.views.WarnableTextInputValidator;
import com.kuyikeji.filemanager.utils.BottomBarButtonPath;
...
import com.kuyikeji.filemanager.utils.SmbStreamer.Streamer;
import com.kuyikeji.filemanager.utils.Utils;
import com.kuyikeji.filemanager.utils.cloud.CloudUtil;
import com.kuyikeji.filemanager.utils.files.CryptUtil;
import com.kuyikeji.filemanager.utils.files.EncryptDecryptUtils;
import com.kuyikeji.filemanager.utils.files.FileListSorter;
...
import static com.kuyikeji.filemanager.fragments.preference_fragments.PreferencesConstants.*;
import static com.kuyikeji.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_DIVIDERS;
import static com.kuyikeji.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_GOBACK_BUTTON;
...
public class MainFragment extends android.support.v4.app.Fragment implements BottomBarButtonPath {
    ...
    public void reloadListElements(boolean back, boolean results, boolean grid) {
        if (isAdded()) {
            ...
            if (null != LIST_ELEMENTS && LIST_ELEMENTS.size() == 0 && !results) {
