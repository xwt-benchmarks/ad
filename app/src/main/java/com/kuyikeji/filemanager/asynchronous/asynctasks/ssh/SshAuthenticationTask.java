...
package com.kuyikeji.filemanager.asynchronous.asynctasks.ssh;
...
import com.kuyikeji.filemanager.asynchronous.asynctasks.AsyncTaskResult;
...
import static com.kuyikeji.filemanager.filesystem.ssh.SshConnectionPool.SSH_CONNECT_TIMEOUT;

/**
 * {@link AsyncTask} for authenticating with SSH server to verify if parameters are correct.
 *
 * Used by {@link com.kuyikeji.filemanager.ui.dialogs.SftpConnectDialog}.
 *
 * @see SSHClient
 * @see SSHClient#authPassword(String, String)
 * @see SSHClient#authPublickey(String, KeyProvider...)
 * @see com.kuyikeji.filemanager.ui.dialogs.SftpConnectDialog#authenticateAndSaveSetup(String, String, int, String, String, String, String, KeyPair, boolean)
 * @see com.kuyikeji.filemanager.filesystem.ssh.SshConnectionPool#create(Uri)
 */
